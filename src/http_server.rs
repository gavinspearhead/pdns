...
async fn get_success(
    ...
    match path.as_slice() {
        ...
        [part1] if part1 == "day" => HttpResponse::Ok().json(stats_data.success_time_stats.per_day.items),
        [part1] if part1 == "minute" => HttpResponse::Ok().json(stats_data.success_time_stats.per_minute.items),
        [part1] if part1 == "hour" => HttpResponse::Ok().json(stats_data.success_time_stats.per_hour.items),
        [part1] if part1 == "second" => HttpResponse::Ok().json(stats_data.success_time_stats.per_second.items),
        [part1] if part1 == "month" => HttpResponse::Ok().json(stats_data.success_time_stats.per_month.items),
...
async fn get_total(
    ...
    match path.as_slice() {
        ...
        [part1] if part1 == "day" => HttpResponse::Ok().json(stats_data.total_time_stats.per_day.items),
        [part1] if part1 == "minute" => HttpResponse::Ok().json(stats_data.total_time_stats.per_minute.items),
        [part1] if part1 == "hour" => HttpResponse::Ok().json(stats_data.total_time_stats.per_hour.items),
        [part1] if part1 == "second" => HttpResponse::Ok().json(stats_data.total_time_stats.per_second.items),
        [part1] if part1 == "month" => HttpResponse::Ok().json(stats_data.total_time_stats.per_month.items),
        _ => HttpResponse::NotFound().body("Invalid route"),
    }
}
async fn get_blocked(
    ...
    match path.as_slice() {
        ...
        [part1] if part1 == "day" => HttpResponse::Ok().json(stats_data.blocked_time_stats.per_day.items),
        [part1] if part1 == "minute" => HttpResponse::Ok().json(stats_data.blocked_time_stats.per_minute.items),
        [part1] if part1 == "hour" => HttpResponse::Ok().json(stats_data.blocked_time_stats.per_hour.items),
        [part1] if part1 == "second" => HttpResponse::Ok().json(stats_data.blocked_time_stats.per_second.items),
        [part1] if part1 == "month" => HttpResponse::Ok().json(stats_data.blocked_time_stats.per_month.items),
        _ => HttpResponse::NotFound().body("Invalid route"),
    }
}
...
async fn get_debug(
    tcp_list: web::Data<Arc<Mutex<TCP_Connections>>>,
) -> impl Responder {
    let tcp_data = tcp_list.lock().unwrap().clone();
