...
pub(crate) fn dns_parse_rdata(
    ...
    match rrtype {
        ...
        DNS_RR_type::AFSDB => Ok(RR_AFSDB::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::DSYNC => Ok(RR_DSYNC::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::IPSECKEY => Ok(RR_IPSECKEY::parse(rdata, packet, offset_in)?.to_string()),
        DNS_RR_type::ISDN => Ok(RR_ISDN::parse(rdata)?.to_string()),
        DNS_RR_type::KEY => Ok(RR_KEY::parse(rdata)?.to_string()),
        DNS_RR_type::KX => Ok(RR_KX::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::LP => Ok(RR_LP::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::MX => Ok(RR_MX::parse(packet, offset_in)?.to_string()),
        DNS_RR_type::NAPTR => Ok(RR_NAPTR::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::NSEC => Ok(RR_NSEC::parse(rdata, packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::PX => Ok(RR_PX::parse(packet, offset_in)?.to_string()),
        DNS_RR_type::RESINFO => Ok(RR_RESINFO::parse(rdata)?.to_string()),
        DNS_RR_type::RKEY => Ok(RR_RKEY::parse(rdata)?.to_string()),
        DNS_RR_type::RP => Ok(RR_RP::parse(packet, offset_in)?.to_string()),
        DNS_RR_type::RRSIG => Ok(RR_RRSIG::parse(packet, offset_in)?.to_string()),
        DNS_RR_type::RT => Ok(RR_RT::parse(packet, offset_in)?.to_string()),
        DNS_RR_type::SIG => Ok(RR_SIG::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::SRV => Ok(RR_SRV::parse(packet, offset_in)?.to_string()),
        ...
        DNS_RR_type::TKEY => Ok(RR_TKEY::parse(packet, offset_in)?.to_string()),
        DNS_RR_type::TLSA => Ok(RR_TLSA::parse(rdata)?.to_string()),
        DNS_RR_type::TSIG => Ok(RR_TSIG::parse(packet, offset_in)?.to_string()),
